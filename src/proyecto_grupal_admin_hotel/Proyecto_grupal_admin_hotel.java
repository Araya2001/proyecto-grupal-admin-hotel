...
public class Proyecto_grupal_admin_hotel {
    ...
    public static void main(String[] args) {
        Reservacion_Habitacion r1 = new Reservacion_Habitacion();
        Reservacion_Habitacion r2 = new Reservacion_Habitacion("Alejandro Jimenez", 101, 4, Estados.Disponible, Habitaciones.Deluxe, 4);
